(function(){
  ...
  const paymentCta = document.querySelector(".payment-banner a");
  if (paymentCta) {
    paymentCta.setAttribute("href", "#demo");
    paymentCta.setAttribute("aria-label", "Tarif bo‘yicha demo va to‘lov ma’lumotini olish");
    paymentCta.addEventListener("click", (event) => {
