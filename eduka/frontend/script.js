...
const translations = {
  uz: {
    ...
    login: "Kirish",
    demo: "7 kun bepul",
    heroBadge: "O'quv markazlar uchun raqamli boshqaruv",
    heroTitle: "O'quv markazingizni yangi bosqichga olib chiqing",
    heroText:
      "Eduka - bu tizimli boshqaruv, avtomatlashtirish va real nazorat. Qo'lda bajariladigan ishlarni qisqartiring, vaqtni tejang va markazingiz o'sishini aniq ko'ring.",
    trial: "Hoziroq sinab ko'ring - 7 kun bepul",
    salesButton: "Sotuv bo'limi",
    seePricing: "Narxlarni ko'rish",
    priceSignal: "7 kun bepul sinov, karta talab qilinmaydi",
    betaSignal: "Sotuv bo'limi markazingizga mos tarifni 15 daqiqada tushuntiradi",
    crmMenu: "Boshqaruv",
    ...
    popular: "Ommabop",
    trialChip: "7 kun bepul",
    choose: "7 kun bepul boshlang",
    custom: "Kelishiladi",
    enterprise: "filialli markazlar",
    contact: "Sotuv bilan bog'lanish",
    ...
    salesCta: "7 kun bepul sinab ko'rish",
    ...
    q2: "7 kun bepul trial qanday ulanadi?",
    a2: "Formani to'ldirsangiz, sotuv jamoasi siz bilan bog'lanib markazingizga mos trial va tarifni tushuntiradi.",
    ...
    modalBadge: "7 kun bepul trial",
    modalTitle: "Eduka'ni 7 kun bepul sinab ko'ring",
    modalText: "Ism, telefon va markaz nomini qoldiring. Sotuv bo'limi sizga trial ochish va mos tarifni tushuntirish uchun bog'lanadi.",
    sendDemo: "7 kun bepul boshlash",
    namePlaceholder: "Ismingiz",
    centerPlaceholder: "O'quv markaz nomi",
    studentsPlaceholder: "O'quvchi soni",
    toastDemo: "7 kunlik bepul trial so'rovi yuborildi. Tez orada bog'lanamiz.",
    ...
    successText: "15 daqiqa ichida Eduka sotuv jamoasi siz bilan bog'lanadi va 7 kunlik bepul trialni tushuntiradi.",
  ...
  en: {
    ...
    login: "Login",
    demo: "7 days free",
    heroBadge: "Digital management for learning centers",
    heroTitle: "Take your learning center to the next level",
    heroText:
      "Eduka is systematic management, automation and real control. Reduce manual work, save time and see your center's growth clearly.",
    trial: "Try now - 7 days free",
    salesButton: "Sales team",
    seePricing: "See pricing",
    priceSignal: "7-day free trial, no card required",
    betaSignal: "The sales team explains the right plan for your center in 15 minutes",
    crmMenu: "Management",
    ...
    modalTitle: "Try Eduka free for 7 days",
    modalText: "Leave your name, phone and center name. Sales will contact you to open the trial and explain the right plan.",
    sendDemo: "Start 7 days free",
    namePlaceholder: "Your name",
    centerPlaceholder: "Learning center name",
    studentsPlaceholder: "Student count",
    toastDemo: "7-day free trial request sent. We will contact you soon.",
    ...
    successText: "The Eduka sales team will contact you within 15 minutes and explain your 7-day free trial.",
